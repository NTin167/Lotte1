...
--
-- INSERT INTO `lotte`.`employees` (`id`, `address`, `gender`, `name`, `phone_number`) VALUES ('1', 'man thiện', 'nam', 'A', '1231232');
-- INSERT INTO `lotte`.`employees` (`id`, `address`, `gender`, `name`, `phone_number`) VALUES ('2', 'man thiện', 'nữ', 'B', '1412412421');
-- INSERT INTO `lotte`.`employees` (`id`, `address`, `gender`, `name`, `phone_number`) VALUES ('3', 'TNP', 'nam', 'C', '125412412');
